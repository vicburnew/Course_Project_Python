...
def api_stocks_response():
    return {'pagination': {'limit': 100, 'offset': 0, 'count': 5, 'total': 5}, 'data': [
...
def get_stocks_mock_result():
    return [{'price': 223.19, 'stock': 'AAPL'}, {'price': 192.17, 'stock': 'AMZN'}, {'price': 157.07, 'stock': 'GOOGL'},
            {'price': 382.19, 'stock': 'MSFT'}, {'price': 268.46, 'stock': 'TSLA'}]
